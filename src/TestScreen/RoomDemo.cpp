...
void RoomDemo::sceneSetup()
{
  ...
  // engine->getResources()->create<olivera::Model>(std::string("pictureFrame"), std::string("../resources/objects/picture/frame.obj"));
   ...
   cameraTransform->setPosition(glm::vec3(5, 5, 0));
   ...
   cameraTransform1->setPosition(glm::vec3(0, 5, 0));
   ...
   shapeTransform->setPosition(glm::vec3(0.5f, 5.0f, 0.0f));
   ...
   shapeTransform2->setPosition(glm::vec3(25.0f, 15.1f, 0.0f));
   ...
   shapeTransform3->setPosition(glm::vec3(15.0f, 15.1f, 0.0f));
  ...
  /*   std::unique_ptr<GameObject> nanosuitObject = std::make_unique<GameObject>(engine, "blinnPhongShader", "depthShader", "nanosuit");
   ...
   room->getTransform()->setPosition(glm::vec3(0.0f,2.0f,-7.0f));
   room->getTransform()->setScale(glm::vec3(2.0f));
   ...
   coffeeMug->getTransform()->setPosition(glm::vec3(7.5f, 3.7f, 5.0f));
