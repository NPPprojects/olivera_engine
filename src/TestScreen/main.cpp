...
//
//  //Unity Assets
//  engine->getResources()->create<olivera::Model>(std::string("unity"), std::string("../resources/objects/unityAssets/MAGIC.obj"));
//
//  engine->getResources()->create<olivera::Model>(std::string("UnityRoom"), std::string("../resources/objects/unityAssets/NiceRoom.obj"));
//
...
//
//    //Unity Room
//  std::unique_ptr<GameObject> UnityRoom = std::make_unique<GameObject>(engine, "ShadowShader", "depthShader", "UnityRoom");
//  UnityRoom->addLight(lightSources, cameraEntities);
//  UnityRoom->getTransform()->setPosition(glm::vec3(1.0f, 1.0f, 1.0f));
//  UnityRoom->getTransform()->setScale(glm::vec3(1.0f));
//
//  //Table
...
//  room->getTransform()->setPosition(glm::vec3(-1.0f));
...
//
//  //Frame
//  std::unique_ptr<GameObject> Frame = std::make_unique<GameObject>(engine, "ShadowShader", "depthShader", "Plane");
//  Frame->addLight(lightSources, cameraEntities);
//  Frame->getTransform()->setPosition(glm::vec3(1.0f));
//  Frame->getTransform()->setScale(glm::vec3(1.5f));
//
//
//  /**************************************************************ROOM DEMO***************************************************************************/
//  engine->start();
